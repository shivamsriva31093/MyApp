...
/**
 * Created by sHIVAM on 2/23/2018.
 */
...
public class PlacesAutocompleteAdapter
    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        LOGI(TAG, "Starting autocomplete query for: " + constraint);
        ...
        try {
            ...
            LOGI(TAG, "Query completed. Received " + autocompletePredictions.getCount()
                    + " predictions.");
            ...
            LOGE(TAG, "Error getting autocomplete prediction API call", e);
            return null;
        }
    }
}