...
import task.myapp.ui.explore.inner.InnerAdapter;
...
public class OuterItem extends HeaderItem {
    ...
    private BottomSheetStateListener mListener;

    public OuterItem(View itemView, RecyclerView.RecycledViewPool pool, BottomSheetStateListener listener) {
        super(itemView);
        // Init header
...
//                onItemScrolled(recyclerView, dx, dy);
        ...
        mHeader.setOnClickListener(view -> mListener.setSheetState(BottomSheetBehavior.STATE_EXPANDED));
    }
    ...
    public interface BottomSheetStateListener {
        int getCurrenBottomSheetState();
        void setSheetState(int newState);
    }
