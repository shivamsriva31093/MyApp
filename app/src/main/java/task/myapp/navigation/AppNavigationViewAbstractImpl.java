...
import task.myapp.archframework.PresenterImpl;
import task.myapp.archframework.UpdatableView;
import task.myapp.R;
import task.myapp.navigation.NavigationModel.NavigationItemEnum;
import task.myapp.navigation.NavigationModel.NavigationQueryEnum;
import task.myapp.navigation.NavigationModel.NavigationUserActionEnum;
