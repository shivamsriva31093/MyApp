...
import task.myapp.R
import task.myapp.navigation.AppNavigationView
import task.myapp.navigation.NavigationModel.NavigationItemEnum
import task.myapp.navigation.AppNavigationViewAsBottomNavImpl
import task.myapp.utils.FontCache
import task.myapp.utils.LogUtils.makeLogTag
...
abstract class BaseActivity : AppCompatActivity() {
    ...
    var selfNavDrawerItem:NavigationItemEnum = NavigationItemEnum.INVALID
        ...
        get() {
            if (mToolbar == null) {
                ...
                if (mToolbar != null) {
                    ...
                    mToolbarTitle = mToolbar?.findViewById<View>(R.id.toolbar_title) as TextView
                    if (mToolbarTitle != null) {
                        val titleId = navigationTitleId
                        if (titleId != 0) {
...
//        }
    ...
    companion object {
        ...
        private val TAG = makeLogTag(BaseActivity::class.java)
